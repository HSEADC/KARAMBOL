...
;// ./src/javascript/components/SearchResultsPage.jsx
...
function SearchResultsPage_slicedToArray(r, e) { return SearchResultsPage_arrayWithHoles(r) || SearchResultsPage_iterableToArrayLimit(r, e) || SearchResultsPage_unsupportedIterableToArray(r, e) || SearchResultsPage_nonIterableRest(); }
function SearchResultsPage_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function SearchResultsPage_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return SearchResultsPage_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? SearchResultsPage_arrayLikeToArray(r, a) : void 0; } }
function SearchResultsPage_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function SearchResultsPage_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function SearchResultsPage_arrayWithHoles(r) { if (Array.isArray(r)) return r; }
...
var SearchResultCard = function SearchResultCard(_ref) {
  ...
  return /*#__PURE__*/react.createElement("a", {
    ...
    className: "W_searchPageCardImage"
  }, image && /*#__PURE__*/react.createElement("img", {
    src: image,
    alt: title
  })), /*#__PURE__*/react.createElement("div", {
    className: "W_searchPageCardContent".concat(centered ? ' W_searchPageCardContent--centered' : '')
  }, /*#__PURE__*/react.createElement("div", {
    className: "W_articleMainInfoDesc"
  }, /*#__PURE__*/react.createElement("h3", null, title), description && /*#__PURE__*/react.createElement("p", {
    className: "A_searchPageDesc"
  }, description)), meta && /*#__PURE__*/react.createElement("p", {
    className: "A_searchPageMeta"
  }, meta)));
};

// Карточка теста — как на странице тестов (M_testPageCard)
var TestPageCard = function TestPageCard(_ref2) {
  var test = _ref2.test,
    onSelect = _ref2.onSelect;
  return /*#__PURE__*/react.createElement("a", {
    href: "./learning.html?test=".concat(test.id),
    ...
    className: "W_testPageImage"
  }, /*#__PURE__*/react.createElement("img", {
    src: test.image,
    alt: test.title
  })), /*#__PURE__*/react.createElement("div", {
    className: "W_testPageContent"
  }, /*#__PURE__*/react.createElement("h3", {
    className: "A_testPageTitle"
  }, test.title), /*#__PURE__*/react.createElement("p", {
    className: "A_testPageDesc"
  }, test.description)), /*#__PURE__*/react.createElement("div", {
    className: "W_testPageFooter"
...
var SearchResultsPage = function SearchResultsPage() {
  ...
  var _useState = (0,react.useState)(function () {
    ...
    _useState2 = SearchResultsPage_slicedToArray(_useState, 2),
    isMobile = _useState2[0],
    setIsMobile = _useState2[1];
  var _useState3 = (0,react.useState)(null),
    _useState4 = SearchResultsPage_slicedToArray(_useState3, 2),
    activeTest = _useState4[0],
    setActiveTest = _useState4[1];
  ...
  var filteredPlaces = (0,react.useMemo)(function () {
    return q ? riskPoints_namespaceObject.filter(function (p) {
      return p.name.toLowerCase().includes(q);
    }) : [];
  }, [q]);
  var filteredArticles = (0,react.useMemo)(function () {
    return q ? articlesData.filter(function (a) {
      return a.title.toLowerCase().includes(q) || a.description.toLowerCase().includes(q);
    }) : [];
  }, [q]);
  var filteredTests = (0,react.useMemo)(function () {
    return q ? testsIndex_namespaceObject.filter(function (t) {
      return t.title.toLowerCase().includes(q) || t.description.toLowerCase().includes(q);
    }) : [];
  }, [q]);
  var totalCount = filteredPlaces.length + filteredArticles.length + filteredTests.length;
  var pluralResult = function pluralResult(n) {
    var mod10 = n % 10;
    var mod100 = n % 100;
  ...
  }, /*#__PURE__*/react.createElement("p", null, "\u041D\u0430\u0439\u0434\u0435\u043D\u043E ", totalCount, " ", pluralResult(totalCount))), /*#__PURE__*/react.createElement("div", {
    className: "W_searchPageContent"
  }, filteredPlaces.length > 0 && /*#__PURE__*/react.createElement("div", {
    className: "W_searchPageSection"
  }, /*#__PURE__*/react.createElement("h2", null, "Events \u0438 \u043C\u0435\u0441\u0442\u0430"), /*#__PURE__*/react.createElement("div", {
    className: "C_searchPageGrid"
  }, filteredPlaces.map(function (p) {
    return /*#__PURE__*/react.createElement(SearchResultCard, {
      key: p.id,
  ...
  }))), filteredArticles.length > 0 && /*#__PURE__*/react.createElement("div", {
    className: "W_searchPageSection"
  }, /*#__PURE__*/react.createElement("h2", null, "\u0421\u0442\u0430\u0442\u044C\u0438"), /*#__PURE__*/react.createElement("div", {
    className: isMobile ? 'C_articlesGrid' : 'C_searchPageGrid'
  }, filteredArticles.map(function (a) {
    return isMobile ? /*#__PURE__*/react.createElement(articles_ArticleCard, {
      key: a.id,
      article: a,
      isLarge: false
    }) : /*#__PURE__*/react.createElement(SearchResultCard, {
      key: a.id,
      image: a.image,
      title: a.title,
      description: a.description,
      meta: "\u0421\u0442\u0430\u0442\u044C\u044F".concat(a.readTime ? " \xB7 ".concat(a.readTime) : ''),
      link: a.link
    });
  }))), filteredTests.length > 0 && /*#__PURE__*/react.createElement("div", {
    className: "W_searchPageSection"
  }, /*#__PURE__*/react.createElement("h2", null, "\u0422\u0435\u0441\u0442\u044B"), /*#__PURE__*/react.createElement("div", {
    className: isMobile ? 'C_testsGrid' : 'C_searchPageGrid'
  }, filteredTests.map(function (t) {
    return isMobile ? /*#__PURE__*/react.createElement(TestPageCard, {
      key: t.id,
      test: t,
      onSelect: openTest
    }) : /*#__PURE__*/react.createElement(SearchResultCard, {
  ...
  })))), totalCount === 0 && q && /*#__PURE__*/react.createElement("p", {
    className: "A_searchEmpty"
  }, "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E \u043F\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0443 \xAB", query, "\xBB"), !q && /*#__PURE__*/react.createElement("p", {
    className: "A_searchEmpty"
  }, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u0430\u043F\u0440\u043E\u0441 \u0432 \u0441\u0442\u0440\u043E\u043A\u0443 \u043F\u043E\u0438\u0441\u043A\u0430"), /*#__PURE__*/react.createElement(organisms_QuizModal, {
    isOpen: !!activeTest,
    testData: activeTest,
...
/* harmony default export */ const components_SearchResultsPage = (SearchResultsPage);
;// ./src/javascript/searchPageApp.jsx



var container = document.getElementById('search-page-root');
if (container) {
  var root = (0,client.createRoot)(container);
  root.render(/*#__PURE__*/react.createElement(components_SearchResultsPage, null));
}
})();
